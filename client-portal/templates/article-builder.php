...
<div class="modal fade cp-modal cp-confirm-article-modal" id="cp-confirm-article-modal" tabindex="-1" aria-labelledby="cp-confirm-title" aria-hidden="true"><div class="modal-dialog modal-dialog-centered"><div class="modal-content"><div class="modal-header"><div><p class="cp-eyebrow mb-1"><?php esc_html_e('Final Review', 'client-portal'); ?></p><h2 class="modal-title" id="cp-confirm-title"><?php echo $is_edit ? esc_html__('Confirm Article Update', 'client-portal') : esc_html__('Confirm Article Creation', 'client-portal'); ?></h2></div><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php esc_attr_e('Close', 'client-portal'); ?>"></button></div><div class="modal-body"><dl class="cp-confirm-summary"><div><dt><?php esc_html_e('Title', 'client-portal'); ?></dt><dd data-cp-summary-title></dd></div><div><dt><?php esc_html_e('Status', 'client-portal'); ?></dt><dd data-cp-summary-status></dd></div><div><dt><?php esc_html_e('Category', 'client-portal'); ?></dt><dd data-cp-summary-category></dd></div><div><dt><?php esc_html_e('Number of blocks', 'client-portal'); ?></dt><dd data-cp-summary-count></dd></div></dl><div class="cp-confirm-blocks"><strong><?php esc_html_e('Block list', 'client-portal'); ?></strong><ol data-cp-summary-blocks></ol></div></div><div class="modal-footer"><button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal"><?php esc_html_e('Cancel', 'client-portal'); ?></button><button type="button" class="btn btn-primary" data-cp-confirm-save><i class="bi bi-check2"></i> <?php esc_html_e('Confirm and Save', 'client-portal'); ?></button></div></div></div></div>
